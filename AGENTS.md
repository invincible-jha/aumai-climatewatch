# Agent Instructions for Climatewatch

## Project Context
Climatewatch is an open source Climate monitoring with IMD data and flood/drought early warning.

## Repository Layout
- `src/aumai_climatewatch/` — package source
